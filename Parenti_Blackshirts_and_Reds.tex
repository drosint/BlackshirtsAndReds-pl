...
Znamienne dla faszyzmu narodowy szowinizm, rasiz, seksizm i patriarchalne wartości również służyły konserwatywnemu interesowi klasowemu. Faszystowska doktryne, a sczególnie jej nazistowska odmiana poświęca szczególnie dużą uwagę rasowej supremacji. Ludzkie cechy, włączając w to przynależność klasową mają być dziedziczone przez krew; pozycja człowieka w strukturze społecznej jest traktowana jako odzwierciedlenie jego przyrodzonej natury. Genetyka i biologia są wykorzystywane do uzasadnienia struktury klasowej, podobnie jak dzisiejsi akademiccy rasiści wykorzystują swoje teorie "krzywej Bella" i odgrzewanymi bzdurami na temat eugeniki.

Oprócz nierówności rasowych i klasowych, faszyzm wspiera homofobię i seksizm. Jednymi z pierwszych ofiar nazistów byli nazistowscy homoseksualiści, przywódcy oddziałów SA. Gdy po przejęciu władzy do Hitlera zaczęły docierać skargi na jawnie homoseksualne zachowanie przywódcy SA, Ernsta Röhma i niektórych szturmowców spośród jego brunatnych koszul, wydał on oficjalne oświadczenie, w którym stwierdził, że kwestia ta należy "wyłącznie do sfery prywatnej" i że "życie prywatne oficera SA nie może być przedmiotem kontroli, chyba że jest sprzeczne z podstawowymi zasadami ideologii narodowo-socjalistycznej".
...
Po wykorzystaniu SA do przejęcia władzy państwowej, Hitler wykorzystał tę władzę, aby zneutralizować SA. Nagle homoseksualizm Röhma zaczął stać w sprzeczności z ideologią nazistowską. W rzeczywistości przywódcy SA musiało zostać pokonane nie dlatego, że jego przywódcy byli homoseksualistami - choć taki był oficjalny powód - ale dlatego, że SA groziło przekształceniem się w poważny problem. Röhm i około 300 innych członków SA zostało straconych, z których nie wszyscy byli homoseksualistami. Wśród ofiar znalazł się weteran nazistowskiej propagandy, Gregor Strasser, podejrzewany o lewicowe poglądy.

Oczywiście wielu nazistów było zajadłymi homofobami. Jeden z najpotężniejszych spośród nich, przywódca SS Heinrich Himmler postrzegał homoseksualistów jako zagrożenie dla niemieckiej męskości i moralności narodów germańskich, ponieważ "homoseksualna sierota" nie będzie miała dzieci i nigdy nie będzie dobrym żołnierzem. Homofobia i seksizm Himmlera zbiegły się, gdy oświadczył: "Jeśli mężczyzna spojrzy na dziewczynę w Ameryce, może zostać zmuszony do poślubienia jej lub zapłacenia odszkodowania. Dlatego mężczyźni w USA chronią się zostając homseksualistami. Kobiety w USA są jak topory bojowe - sieką mężczyzn".\footnote{Richard Plant, \textit{The Pink Triangle, 91}} Tak rzecze jeden z największych umysłów nazimu.
